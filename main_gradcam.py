...
import cv2
# 数据集类别名
names = ['bridge', 'missing_component', 'missing_solder']  # class names
# yolov5s网络中的三个detect层
target_layers = ['model_17_cv3_act', 'model_20_cv3_act', 'model_23_cv3_act']

# Arguments
parser = argparse.ArgumentParser()
parser.add_argument('--model-path', type=str, default=r"D:\PCB_defect\runs\train\yolov5n_PCB_distill_exp64\weights\best.pt", help='Path to the model')
parser.add_argument('--img-path', type=str, default=r'D:\PCB_defect\datasets\Joint_PCB\Images\41_1.bmp', help='input image path')
