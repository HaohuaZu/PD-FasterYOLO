...
class ConfusionMatrix:
    ...
    def plot(self, normalize=True, save_dir='', names=()):
        ...
        ax.set_xlabel('True')
        ax.set_ylabel('Predicted', dpi=250)
        plt.close(fig)
        ax.set_title('Confusion Matrix')
        fig.savefig(Path(save_dir),'confusion_matrix.png')
...
def bbox_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False, SIoU=False, EIoU=True, Focal=False, alpha=1, gamma=0.5, eps=1e-7):
